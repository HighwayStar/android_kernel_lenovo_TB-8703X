...
#define DEV_PACKFILTER_NAME		"packfilter"		
#define DEV_PF_FULLNAME			"/dev/packfilter"	
#define NETLINK_PACKFILTER		28					
#define ALLOCMEM_HIGH_FLAG		GFP_KERNEL			
#define ALLOCMEM_MIDD_FLAG		GFP_KERNEL			
...
typedef struct
{
	uint64_t uFromPackBytes;	
	uint64_t uToPackBytes;		
} SNodeStat;
...
#define PACKFILTER_IOCTL_GET_IPSTATRSU		0x83	
...
#define PACKFILTER_IOCTL_SET_CLSBYUID	 	0x8A	
#define PACKFILTER_IOCTL_SET_CURUID	 	0x8B	
#endif	
